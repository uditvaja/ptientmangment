...
import "./MonitorBillingInvoice.scss"
  ...
  return (
    <div className="d-flex">
      ...
      <div className="w-85 w-md-100">
        ...
        <div className="container-fluid monitor-billing-invoice-page py-4">
          <div className="invoice-container">
            ...
            <div className="monitor-billing-doctor-info">
            ...
            <div className="monitor-billing-invoice-details monitor-billing-invoice-details-spacing">
              <div className="row">
                <div className="col-md-6">
            ...
            <div className="table-responsive">
              <table className="table align-middle monitor-billing-invoice-table">
                <thead>
                  <tr>
            ...
            <div className="monitor-billing-details">
              <div className="row">
                <div className="col-md-6">
            ...
            <div className="monitor-billing-footer">
...
export default MonitorBillingInvoice