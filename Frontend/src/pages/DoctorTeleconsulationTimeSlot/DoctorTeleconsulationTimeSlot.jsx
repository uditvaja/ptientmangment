...
import "./DoctorTeleconsulationTimeSlot.scss";
import DoctorSidebar from "../../components/DoctorSidebar/DoctorSidebar";

const DoctorTeleconsulationTimeSlot = () => {
  ...
  return (
    <div className="d-flex">
      ...
      <div className="w-85 w-md-100">
        ...
        <div className="container-fluid doctorTelAppointmenttime-page py-4">
      ...
      <Modal
        ...
        className="doctorTelAppointmenttime-modal"
      >
        <Modal.Header>
...
export default DoctorTeleconsulationTimeSlot;
