              ...
              <Card.Body>
                ...
                <div className="card-details">
                  <div className="row mb-2">
                    ...
                    <div className="col-sm-6">
                      <p className="mb-0 text-end total-amount">{doctor?.totalBillAmount}</p>
                    </div>
                  </div>
                  <button
                    type="button"
          ...
          <div className="col-xl-3 col-lg-4 col-md-6" key={index}>
            <Card className="mb-3">
              <Card.Body>
                <div className="d-flex justify-content-between align-items-center mb-2">
                  <h5 className="card-title">{doctor?.name}</h5>
                  <button type="button" className="eyebtn" onClick={handlePaidNavigation}>
                    <img
                      src="/assets/images/eye-blue-2.svg"
                      alt="eye-blue"
                      className="img-fluid eye-icon"
                ...
                <div className="card-details">
                  <div className="row mb-2">
                    ...
                    <div className="col-sm-6">
                      <p className="mb-0 text-end total-amount-paid">{doctor?.totalBillAmount}</p>
                    </div>
                  </div>
                </div>
              </Card.Body>
        ...
        <div className="container-fluid patients-bills py-4">
          ...
          >
            <Tab eventKey="unpaidbills" title="Unpaid Bills">
              ...
              <div className="row">
                <UnpaidCard doctors={doctors} handleNavigation={handleNavigation} />
              </div>
            </Tab>
            <Tab eventKey="paidbills" title="Paid Bills">
              ...
              <div className="row">
                <PaidBillCard doctors={doctors} handlePaidNavigation={handlePaidNavigation} />
              </div>
            </Tab>
          </Tabs>
        </div>
