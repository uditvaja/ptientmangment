...
const Register = () => {
  ...
  const fetchStates = async (countryCode) => {
    try {
      const response = await axios.get(`https://example.com/api/states/${countryCode}`);
  ...
  const fetchCities = async (stateCode) => {
    try {
      const response = await axios.get(`https://example.com/api/cities/${stateCode}`);
                ...
                {({ errors, touched, values, setFieldValue }) => (
                  <Form>
                    ...
                    <div className="form-floating mb-3">
                      <Field as="select" name="hospital" className="form-select">
                    ...
                    <div className="form-floating mb-3 position-relative">
                      ...
                      >
                        <img
                          src={showPassword ? './assets/images/eye-slash.svg' : './assets/images/eye.svg'}
                          alt="toggle password"
                          className="img-fluid"
                        />
                      </button>
                    ...
                    <div className="form-floating mb-3 position-relative">
                      ...
                      >
                        <img
                          src={showConfirmPassword ? './assets/images/eye-slash.svg' : './assets/images/eye.svg'}
                    ...
                    <div className="mb-3 form-check">
                      ...
                      <label className="form-check-label" htmlFor="agreeToTerms">
                        I agree to the <span style={{ color: 'blue' }}>Terms</span> and <span style={{ color: 'blue' }}>Privacy Policy</span>
                      </label>
                    ...
                    <div className="text-center account-text mt-3">
                      ...
                      <Link to={"/login"} className="main-link ms-1">Login</Link>
                    </div>
                  </Form>
                )}
              </Formik>
